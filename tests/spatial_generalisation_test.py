...
# Test cases for format_coordinates
    def test_format_coordinates_valid_input():
        ...
        lat, lon = TestSpatialGeneraliser.spatial_generaliser.format_coordinates(input_data)
    ...
    def test_format_coordinates_invalid_input(invalid_input):
        ...
        with pytest.raises((ValueError, IndexError)):
            TestSpatialGeneraliser.spatial_generaliser.format_coordinates(pd.Series([invalid_input]))
    ...
    def test_generalise_spatial_valid_input():
        ...
        result = TestSpatialGeneraliser.spatial_generaliser.generalise_spatial(lat, lon, resolution)
    ...
    def test_generalise_spatial_invalid_resolution(invalid_resolution):
        ...
        with pytest.raises(ValueError):
            TestSpatialGeneraliser.spatial_generaliser.generalise_spatial(lat, lon, invalid_resolution)
    ...
    def test_generalise_spatial_mismatched_series():
        ...
        with pytest.raises(Warning):
            TestSpatialGeneraliser.spatial_generaliser.generalise_spatial(lat, lon, resolution)
    ...
    def test_random_coordinates():
        ...
        n_points = 100
        lat, lon = TestSpatialGeneraliser.generate_random_coordinates(n_points)
        resolution = 7
        ...
        parsed_lat, parsed_lon = TestSpatialGeneraliser.spatial_generaliser.format_coordinates(coord_strings)
        assert len(parsed_lat) == n_points
        assert len(parsed_lon) == n_points
        
        # Test generalise_spatial
        h3_indexes = TestSpatialGeneraliser.spatial_generaliser.generalise_spatial(parsed_lat, parsed_lon, resolution)
